...
<!--            <li class="search-box">
        ...
        <ul class="nav-right">
            ...
            <li class="dropdown">
                <a href="" class="dropdown-toggle peers fxw-nw ai-c lh-1 col" data-toggle="dropdown">
                    <div class="peer mR-10 ">
                        {{--<img class="w-2r bdrs-50p" src="{{ auth()->user()->avatar }}" alt="">--}}
                        <img class="w-2r bdrs-50p" src="/images/user.jpg" alt="">
...
{{--                    <li>
                    ...
                    <li>
                        <a href="{{ route('accounts.edit', auth()->user()->id) }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
