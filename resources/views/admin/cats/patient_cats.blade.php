                        ...
                        <td>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    ...
                                    <button class="btn btn-danger btn-sm" title="{{ trans('app.delete_title') }}" data-msg="{{trans('app.delete_msg',['obj'=>"το CAT",'name'=>$item->diagnose_date])}}"><i class="ti-trash"></i></button>
